import { getActiveSidebarSize, normalizeSidebarSizeMode } from '../core/core.ts'
import { t as accountSettingsPaneT } from '../settings/translationsHook.ts'
import { createControlButton } from '../ui/controlButton.ts'
import {
    ...
    restoreSidebarItem,
} from './sidebarContent.ts'
import { sidebarItemLabelKey } from './sidebarItemLabels.ts'
