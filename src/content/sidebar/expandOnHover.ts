...
import { buildSidebarFullLayoutCss } from './sidebarLayout.ts'

const RP_EXPAND_ON_HOVER_ACTIVE_CLASS = 'roprime-sidebar-expand-on-hover-active'
const RP_EXPAND_ON_HOVER_EXPANDED_CLASS = 'roprime-sidebar-expand-on-hover-expanded'
const RP_EXPAND_ON_HOVER_EXPANDED_STYLE_ID = 'roprime-sidebar-expand-on-hover-expanded-style'
...
export function syncExpandSidebarOnHover() {
    const enabled = !!settingsState.expandSidebarOnHoverEnabled &&
        shouldApplySidebarModifications()
