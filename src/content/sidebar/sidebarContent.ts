...
import { createRoPrimeNavMenuButton, setCollapseButtonIcon } from '../ui/collapse.ts'
import { syncSidebarCompactDecorations, updateSidebarCompactVisibility } from './sidebarCompact.ts'
import { updateSmallNewNavVisibility } from './smallNewNav.ts'
...
function findGameEventsItem(nav) {
    const eventsNav = nav.querySelector('div.roblox-events') ||
...
const SIDEBAR_ITEM_HIDE_CSS = 'display:none!important'
    ...
    if (noSidebarButtons) {
        extraBlocks.push(
            [
                ...
                '@media (max-width: 747px) { html.roprime-account-settings-open main.container-main .content.roprime-settings-page-content, html.roprime-account-settings-open #content.roprime-settings-page-content { min-height: 0 !important; padding-top: 12px !important; padding-bottom: 12px !important; } }',
            ].join('\n'),
        )
    }
