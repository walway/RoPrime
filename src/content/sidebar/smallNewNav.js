...
>>>>>>> 4eca88e2c93930f0cc65dd2180063f43a7c759a9
...
const SMALL_NEW_NAV_BASE_CSS = [
    ...
    '{ width: 217px !important; min-width: 0 !important; max-width: 217px !important; }',
].join('\n')
...
function restoreSmallNavSidebarLabels() {
    ...
    while (node) {
        ...
        if (
            ...
            node.nodeValue = parent.getAttribute('data-rp-orig-text') ||
                node.nodeValue
