import { fetchTextPreferBackground } from './backgroundFetch.ts'

const CLIENT_LOCALES_BASE = 'https://raw.githubusercontent.com/walway/Roblox-Datamine/main/Client/Locales/Common'
