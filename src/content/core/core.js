...
export function syncAccountSettingsLayoutInset() {
    ...
    const effectiveSize = settingsState.sidebarCollapseMenuEnabled &&
...
export function serializeSettingsPayload() {
    return {
        ...
        profileEffectsEquippedByUser: settingsState.profileEffectsEquippedByUser &&
            ...
            : {},
        profileEffectsSupportNoticeAccepted: !!settingsState.profileEffectsSupportNoticeAccepted,
...
export function buildRoPrimeSettingsFullUrl(
    ...
    const base = `${window.location.origin}${getRobloxLocalePathPrefix()}/my/account?${RP_PARAM_KEY}=${
