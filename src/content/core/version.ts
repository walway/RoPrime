import { getStorageApi, isExtensionContextAlive, settingsState } from './core.ts'

const extensionApi = globalThis.browser || globalThis.chrome

export const VERSION_MANIFEST_URL = 'https://raw.githubusercontent.com/walway/roprime-data/main/v1/version.json'
export const VERSION_UPDATE_DISMISSED_KEY = 'rpVersionUpdateDismissed'
export const VERSION_UPDATE_DISMISSED_VERSION_KEY = 'rpVersionUpdateDismissedVersion'
...
export async function shouldShowVersionUpdate({
    ...
    // major.minor.patch string equality guard
    if (
