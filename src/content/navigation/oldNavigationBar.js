...
const ICON = {
    home:
        `<svg class="roprime-cln-svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M3 10.5L12 3l9 7.5"/><path d="M5 10v10a1 1 0 0 0 1 1h4v-6h4v6h4a1 1 0 0 0 1-1V10"/></svg>`,
    user:
        `<svg class="roprime-cln-svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><circle cx="12" cy="8" r="3.5"/><path d="M6 20v-1a4 4 0 0 1 4-4h4a4 4 0 0 1 4 4v1"/></svg>`,
    message:
        `<svg class="roprime-cln-svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M5 5h14a2 2 0 0 1 2 2v8a2 2 0 0 1-2 2h-4l-4 3v-3H5a2 2 0 0 1-2-2V7a2 2 0 0 1 2-2z"/><path d="M8 10h8"/><path d="M8 13h5"/></svg>`,
    connect:
        `<svg class="roprime-cln-svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><circle cx="9" cy="8" r="3"/><circle cx="17" cy="9" r="2.5"/><path d="M3 20v-1a4 4 0 0 1 4-4h2"/><path d="M17 11.5A4 4 0 0 1 21 15v1"/></svg>`,
    avatar:
        `<svg class="roprime-cln-svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><ellipse cx="12" cy="19.5" rx="5" ry="1.75"/><circle cx="12" cy="8.5" r="3.25"/><path d="M7.5 18.5v-.5a4.5 4.5 0 0 1 9 0v.5"/></svg>`,
    inventory:
        `<svg class="roprime-cln-svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M8 6V5a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v1"/><rect x="4" y="6" width="16" height="14" rx="2"/><path d="M4 11h16"/></svg>`,
    trade:
        `<svg class="roprime-cln-svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M5 5l5 5"/><path d="M5 5v5h5"/><path d="M19 19l-5-5"/><path d="M19 19v-5h-5"/></svg>`,
    communities:
        `<svg class="roprime-cln-svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><circle cx="9" cy="8" r="2.5"/><circle cx="15" cy="7" r="2"/><circle cx="17" cy="13" r="2"/><path d="M3 20v-1a3 3 0 0 1 3-3h1"/><path d="M21 20v-1a3 3 0 0 0-3-3h-1"/><path d="M12 11c-1.5 0-3 1-3 3v2h6v-2c0-2-1.5-3-3-3z"/></svg>`,
    blog:
        `<svg class="roprime-cln-svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M6 4h8l4 4v12a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2z"/><path d="M8 11h8"/><path d="M8 15h5"/></svg>`,
    store:
        `<svg class="roprime-cln-svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><circle cx="9" cy="20" r="1"/><circle cx="18" cy="20" r="1"/><path d="M3 5h2l1 12a2 2 0 0 0 2 1.5h9a2 2 0 0 0 2-1.5L21 9H7"/><path d="M16 5l-2-2h-4"/></svg>`,
    gift:
...
function linkRow(item, messagesBadge) {
    ...
    return `<li><a class="${cls}" href="${
        esc(href)
    }"${target}><span class="${wrapCls}">${icon}</span><span class="roprime-cln-label">${
        esc(item.label)
    }</span>${tail}</a></li>`
}
...
function buildNavHtml(profileHref, avatarUrl, displayName) {
    const links = PRIMARY_LINKS.map((item) =>
        item.path === '/groups'
            ? {
                ...item,
                label: settingsState.renameCommunitiesToGroups ? 'Groups' : 'Communities',
            }
            : item
    )
