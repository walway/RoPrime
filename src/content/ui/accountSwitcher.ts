...
const NAME_FRAME_CLASS = 'roprime-account-switcher-text-frame flex items-center min-width-0 gap-small'

const ADD_TEXT_CLASS = 'roprime-account-switcher-text padding-y-small text-truncate-end text-no-wrap'
...
function restyleAddAccountRow(listItem) {
    ...
    const nameContainer = selection.querySelector('.account-selection-name-container') ||
