...
function placementClass(placement) {
    return placement === 'top' ? 'MuiTooltip-tooltipPlacementTop' : 'MuiTooltip-tooltipPlacementBottom'
}
...
function applyTooltipSurfaceStyles(node) {
    Object.assign(node.style, {
        ...
        lineHeight: '1.4',
        maxWidth: '280px',
        boxShadow: 'var(--shadow-transient-high, 0 8px 24px rgba(0, 0, 0, 0.35))',
        pointerEvents: 'none',
    })
}
...
export function createTooltip(options = {}) {
    ...
    popper.role = 'tooltip'
    popper.className = 'MuiPopper-root MuiTooltip-popper MuiTooltip-popperInteractive MuiTooltip-popperArrow'
