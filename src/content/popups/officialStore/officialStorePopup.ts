...
export function showOfficialStorePopup() {
    ...
    const overlay = el('div', {
        [OVERLAY_ATTR]: 'modern',
        'data-state': 'open',
        className: 'foundation-web-dialog-overlay padding-medium foundation-web-portal-zindex bg-common-backdrop',
    ...
    const dialog = el(
        ...
        [
            ...
            el(
                'div',
                {
                    className: 'padding-x-xlarge padding-top-xlarge padding-bottom-xlarge',
                },
                [
                    el('h2', {
            ...
            el(
                'div',
                {
                    className: 'padding-x-xlarge padding-bottom-xlarge flex gap-medium justify-end',
                },
                [
                    el(
                        'button',
