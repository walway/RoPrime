...
import { getRobloxUserId } from './robloxUserId.ts'
...
export function buildRobloxAvatarHeadshotElement(profile) {
    ...
    container.className = 'user-profile-header-details-avatar-container avatar-headshot-lg roprime-effect-shop-avatar'
