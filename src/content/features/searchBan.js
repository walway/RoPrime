...
errorContainerContentImage.src = "data:image/svg+xml;base64,";
...
errorContainerRefreshButton.classList.add("foundation-web-button relative clip group/interactable focus-visible:outline-focus disabled:outline-none cursor-pointer relative flex items-center justify-center stroke-none padding-y-none select-none radius-medium text-label-medium height-1000 padding-x-medium bg-action-standard content-action-standard");
errorContainerRefreshButton.setAttribute("onclick", "window.location.href='https://roblox.com/home';");
...
errorTextContainer.classList.add("absolute inset-[0] transition-colors group-hover/interactable:bg-[var(--color-state-hover)] group-active/interactable:bg-[var(--color-state-press)] group-disabled/interactable:bg-none");
