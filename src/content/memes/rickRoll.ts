...
function buildRickRollFaq() {
    ...
    wrapper.className = 'radius-medium stroke-standard stroke-default overflow-hidden padding-x-medium padding-y-small'
    ...
    iframe.width = '560'
    iframe.height = '315'
    iframe.src = 'https://www.youtube-nocookie.com/embed/dQw4w9WgXcQ?si=z3oFdFY3HE3Dkufe'
