            ...
            },
            {
                ...
                items: [
                    ...
                    { type: 'separator' },
                    {
                        ...
                        byDefault: false,
                        exclusiveWith: 'alwaysShowCloseButtonEnabled, expandSidebarOnHoverEnabled',
                    },
                    {
                        type: 'toggle',
                        ...
                        byDefault: false,
                        exclusiveWith: 'sidebarCollapseMenuEnabled, expandSidebarOnHoverEnabled',
                    },
                    {
                        type: 'toggle',
                        key: 'expandSidebarOnHoverEnabled',
                        title: 'settings.appearance.sidebar.expandSidebarOnHover',
                        description: 'settings.appearance.sidebar.expandSidebarOnHoverDescription',
                        byDefault: false,
                        exclusiveWith: 'alwaysShowCloseButtonEnabled, sidebarCollapseMenuEnabled',
                    },
                    { type: 'separator' },
                    {
                        type: 'toggle',
